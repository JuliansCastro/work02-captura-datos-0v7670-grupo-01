...
xst -ifn xst.scr
move clk_100MHZ_to_25M_24M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_100MHZ_to_25M_24M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_100MHZ_to_25M_24M_exdes.ucf clk_100MHZ_to_25M_24M_exdes

echo 'Running map'
map -timing -pr b clk_100MHZ_to_25M_24M_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk_100MHZ_to_25M_24M_exdes -w routed.ncd routed.v
cd ..
